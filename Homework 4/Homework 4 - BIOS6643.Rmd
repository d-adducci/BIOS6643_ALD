...
theta_mle <- nr_mle(exp_data,0,20)
theta_mle
...
```
The plot above shows the correlation
...
```
Table 13 shows the fixed effects for the linear mixed effects model with AR(1) variance-covariance. 
```{r,echo = F}
