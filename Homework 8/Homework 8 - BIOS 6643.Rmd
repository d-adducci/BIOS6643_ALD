...
clinical_data <- clinical_data_raw %>%
  ...
  mutate(Ground_Glass = factor(Ground_Glass),
         ...
         Race = factor(Race, levels = c("White","Black or African American",
                                        "Asian","Unknown","American Indian or Alaskan Native",
                                        "Multi_racial or No Primary Race")),
...
#saveRDS(project2_data,"C:/Users/domin/Documents/Biostatistics Masters Program/Fall 2023/BIOS 6643 - ADL/BIOS6643_ALD/Final Project/ProcessedData/project2_data.rds")
